...
function jump(label)
{
    ...
    if (label != "Categorias"){ 
        script[21].splice(script[21].indexOf(label),2); 
    } else if (label == "Categorias" && script[21].length == 1){
        jump("fim");
		return 0;
    }
...
/*
	ADICIONA NA LISTA respostas AS ALTERNATIVAS QUE O ALUNO
	ESCOLHEU RESPONDER
*/
function setVars(respostaEscolhida){ 
	respostas[contador_respostas] = respostaEscolhida;
